...
def test_hpge_activeness():
    ...
    activeness = functions.piecewise_linear_activeness(VectorOfVectors(distances), fccd=1, dlf=0.5)
    ...
    distances = ak.Array([[0.2], [0.6], [2]])
    activeness = functions.piecewise_linear_activeness(distances, fccd=1, dlf=0.5)
    ...
    # test with Array
    activeness = functions.piecewise_linear_activeness([0.2, 0.6, 2], fccd=1, dlf=0.5)
